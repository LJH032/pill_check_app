...
void main() {
  const String nativeAppKey = "fe4182a212808903410b9c65cac7cf6d"; // 카카오 네이티브 앱 키

  KakaoSdk.init(
    nativeAppKey: nativeAppKey, // 카카오 네이티브 앱 키
    loggingEnabled: true, // 디버그용 로깅 활성화
  );

  // 초기화된 네이티브 앱 키 출력
  print("Kakao SDK initialized with nativeAppKey: $nativeAppKey");
